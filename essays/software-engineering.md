...
Upon first stepping into my first class of ICS 314 - Software Engineering, I did not know what to expect. Excited and anxious simultaneously, I knew that software engineering would be a long endeavor in practice. With a final project set to be due by the end of the semester, I was determined to devote my effort to gathering enough knowledge to reach that point. One of the first lessons I learned in software engineering was about functional programming. By using functions as first-class citizens, they can be passed as arguments, returned as values, and assigned to variables. Learning this concept broadened my views immediately as it greatly expanded the tools I had at my disposal. Although these topics were just programming techniques, I was made to think about the possibilities of every single tool at my disposal and to never discount any of them, as a finished puzzle is made of numerous pieces, each of them unique. 
